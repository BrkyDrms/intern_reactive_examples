...
public class Exercise1 {
    ...
    public static void main(String[] args) {
        ...
        //user -> System.out.println(user.getFirstName() == map(user -> user.getFirstName())
        ...
        var s1 = s.flatMap(iD -> StreamSources.userStream().filter(user -> user.getId() == iD)).map(user -> user.getFirstName());
        s1.forEach(valueS -> System.out.println(valueS));
